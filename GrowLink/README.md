...
- `scripts/build.mjs`: 公開用ファイルの作成とリンク確認
- `public/`: ビルド時に作成されるVercel公開用フォルダ
...
404が出る場合は、VercelのProject SettingsでOutput Directoryが `public` になっているか確認してください。
